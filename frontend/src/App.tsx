...
function App() {
  ...
  const removeRow = async () => {
    try {
      ...
      console.error('Помилка при видаленні рядка:', e);
    }
  };
  ...
  const removeColumn = async () => {
    try {
      ...
      console.error('Помилка при видаленні стовпця:', e);
    }
  };
      ...
      <section className="info-panel">
        ...
        {info && (
          <div className="info-content">
            <p><strong>Таблиця:</strong> {info.rows} × {info.cols}</p>
            <p><strong>Операції:</strong> {info.operations.join(', ')}</p>
          </div>
        )}
      </section>
